...
SECRET_KEY = 'django-insecure-b)+89+f9h^b1w2@n#hqxqgl5ybduvg(d4f@imx!!rg_fsgvhjs'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'mysystem.utils.jwt.MyJWTAuthentication' # 认证方式为自定义的认证类
    ],
}
